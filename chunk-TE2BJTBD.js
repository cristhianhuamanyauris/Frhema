import{a as n}from"./chunk-YD4KD56L.js";import{O as a,T as s}from"./chunk-SFQMZB6G.js";import{h as e}from"./chunk-FK42CRUA.js";var u=class o{constructor(i){this.supabase=i}TABLE="usuarios";getUsuarios(){return e(this,null,function*(){let{data:i,error:r}=yield this.supabase.client.from(this.TABLE).select(`
        id_usuario,
        nombre_usuario,
        nombre,
        apellido,
